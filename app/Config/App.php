...
class App extends BaseConfig
{
	...
	|
	*/
	public $baseURL = 'http://localhost/certificadosCongreso'; //toda esa ruta debe pegarse al servidor, pero teniendo en cuenta que el localhost reemplaza por el dominio
